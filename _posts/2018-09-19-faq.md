...
To change the default publish permission: open Facebook via web, go to _Settings_ -> _Apps and websites_ -> _edit LIVE4 GoPro_ -> _"App visibility and post audience"_ permission
...
# When GoPro camera is connected via Wi-Fi to the Android device - internet connection stops working. How do you manage to stream live?
